      ...
      <section className={`min-h-screen flex flex-col transition-all duration-500 ${(demoOpen || getStartedOpen) ? 'opacity-0 scale-95 pointer-events-none' : 'opacity-100 scale-100'}`}>
        ...
        <header className="flex items-center justify-between px-6 py-4 relative z-10">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-semibold text-lg text-foreground">Keyrot</span>
          </div>
          ...
          <a
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-950/50 backdrop-blur-sm border border-emerald-500/20 hover:border-emerald-500/40 hover:bg-emerald-950/70 transition-all text-sm text-muted-foreground hover:text-foreground"
          >
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6">
          <div className="text-center max-w-3xl relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-10">
              <span className="px-3 py-1.5 rounded-full text-sm bg-emerald-950/50 border border-emerald-500/20 text-emerald-300">
                Rate Limiting
              </span>
              <span className="px-3 py-1.5 rounded-full text-sm bg-emerald-950/50 border border-emerald-500/20 text-emerald-300">
                Quota Tracking
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-emerald-500/30 hover:border-emerald-500/50 hover:bg-emerald-500/10 text-foreground font-medium px-8"
              >
                Get Started
              </Button>
              <Button
                onClick={openDemo}
                size="lg"
                className="bg-emerald-500 hover:bg-emerald-600 text-emerald-950 font-medium px-8"
              >
                Demo
              </Button>
            </div>
      ...
      >
        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-4 md:px-8 py-12">
          <div className="w-full max-w-4xl space-y-8">
            ...
            {/* Installation */}
            <div className="border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30 rounded-xl p-6">
              <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-3">Installation</h3>
              <pre className="bg-black/40 rounded-lg p-4 overflow-x-auto">
                <code className="text-emerald-300 text-sm font-mono">npm install keyrot</code>
              </pre>
            </div>

            {/* Basic Usage */}
            <div className="border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30 rounded-xl p-6">
              <h3 className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-3">Basic Usage</h3>
              <pre className="bg-black/40 rounded-lg p-4 overflow-x-auto text-sm font-mono">
  ...
  return fetch('https://api.example.com/data', {
    headers: { Authorization: \`Bearer \${keyValue}\` },
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30 rounded-xl p-5">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h4 className="font-medium text-foreground">Automatic Failover</h4>
                </div>
                <p className="text-sm text-muted-foreground">Seamlessly switches to available keys when one is rate-limited or fails.</p>
              </div>
              ...
              <div className="border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30 rounded-xl p-5">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h4 className="font-medium text-foreground">Quota Tracking</h4>
                </div>
                <p className="text-sm text-muted-foreground">Track monthly, yearly, or total quotas with automatic reset handling.</p>
              </div>
              ...
              <div className="border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30 rounded-xl p-5">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h4 className="font-medium text-foreground">Health Monitoring</h4>
                </div>
                <p className="text-sm text-muted-foreground">Real-time pool health status: healthy, degraded, critical, or exhausted.</p>
              </div>
              ...
              <div className="border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30 rounded-xl p-5">
                ...
                <p className="text-sm text-muted-foreground">Automatic failure detection with configurable recovery thresholds.</p>
              </div>
            </div>
            ...
            <div className="text-center pt-4">
              <Button
                ...
                size="lg"
                className="bg-emerald-500 hover:bg-emerald-600 text-emerald-950 font-medium px-8 group"
              >
                Demo
      ...
      >
        ...
        <div className="px-4 md:px-8 py-12">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <Card className="lg:col-span-2 border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30">
                <CardHeader>
                  ...
                  <CardDescription>Real-time status of all API keys in the pool</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30">
                <CardHeader>
                  ...
                  <CardDescription>Test pool behavior</CardDescription>
                </CardHeader>
              ...
              <Card className="border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30">
                <CardHeader className="pb-3">
                  <CardTitle className="text-base font-medium flex items-center gap-2">
                    <div className={`h-2.5 w-2.5 rounded-full ${getStatusDot(health.status)}`} />
                    Pool Health: <span className={getStatusColor(health.status)}>{health.status.charAt(0).toUpperCase() + health.status.slice(1)}</span>
                  </CardTitle>
                  <CardDescription>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="space-y-1">
                      <p className="text-xs text-muted-foreground uppercase tracking-wider">Available Keys</p>
                      <p className="text-2xl font-semibold tabular-nums">
                        {health.availableKeys}<span className="text-muted-foreground text-lg">/{health.totalKeys}</span>
                      </p>
                    ...
                    <div className="space-y-1">
                      <p className="text-xs text-muted-foreground uppercase tracking-wider">Effective RPS</p>
                      <p className="text-2xl font-semibold tabular-nums">{health.effectiveRps}</p>
                      <p className="text-xs text-muted-foreground">requests/second</p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-xs text-muted-foreground uppercase tracking-wider">Quota Remaining</p>
                      <p className="text-2xl font-semibold tabular-nums">{health.effectiveQuotaRemaining.toLocaleString()}</p>
                      <p className="text-xs text-muted-foreground">
                        of {health.effectiveQuotaTotal.toLocaleString()} ({quotaPercent.toFixed(1)}%)
                      </p>
                    </div>
                    <div className="space-y-1">
                      <p className="text-xs text-muted-foreground uppercase tracking-wider">Active Warnings</p>
                      <p className={`text-2xl font-semibold tabular-nums ${health.warnings.length > 0 ? 'text-amber-400' : ''}`}>
            ...
            <Card className="border-emerald-500/20 bg-emerald-950/60 backdrop-blur-md shadow-lg shadow-emerald-900/30">
              <CardHeader>
                <CardTitle className="text-base font-medium">Request Log</CardTitle>
                <CardDescription>Recent API requests ({results.length} recorded)</CardDescription>
              </CardHeader>
              <CardContent>
                {results.length === 0 ? (
                  <div className="text-center py-12 text-muted-foreground">
                    <div className="mx-auto w-12 h-12 rounded-xl bg-secondary/50 flex items-center justify-center mb-4">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                      </svg>
                    </div>
                    <p className="text-sm">No requests yet</p>
                    <p className="text-xs mt-1">Click &quot;Make Request&quot; to start</p>
                  </div>
                ) : (
                  <div className="max-h-96 overflow-y-auto space-y-1.5">
                    {results.map((result) => (
                      <div
                        key={result.id}
                        className={`flex flex-col px-3 py-2 rounded-lg text-sm overflow-hidden ${result.success
                      ...
                      >
                        <div className="flex items-center justify-between gap-2 min-w-0">
                          <div className="flex items-center gap-2.5 min-w-0 flex-1">
                            ...
                            {result.success ? (
                              <code className="text-emerald-400 font-mono text-xs flex-shrink-0">{result.keyUsed}</code>
                            ) : (
                              <span className="text-red-400 text-xs truncate" title={result.error}>{result.error}</span>
                            )}
                          </div>
                        ...
                        {result.health && (
                          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-1.5 pl-4 text-xs text-muted-foreground">
                            <div className="flex items-center gap-1.5">
                              <div className={`h-1.5 w-1.5 rounded-full flex-shrink-0 ${getStatusDot(result.health.status)}`} />
                            ...
                            <span className="hidden sm:inline">•</span>
                            <span className="tabular-nums">{result.health.effectiveRps} rps</span>
                            <span className="hidden sm:inline">•</span>
                            <span className="tabular-nums">{result.health.effectiveQuotaRemaining.toLocaleString()} quota</span>
                          </div>
                        )}
                      </div>
                    ))}
              ...
              <Card className="border-amber-500/20 bg-amber-500/5">
                <CardHeader className="pb-2">
                  <CardTitle className="text-base font-medium text-amber-400 flex items-center gap-2">
                    ...
                    Active Warnings ({health.warnings.length})
                  </CardTitle>
                  ...
                  <div className="space-y-2">
                    {health.warnings.map((warning, i) => (
                      <div key={i} className="flex items-start gap-2 text-sm">
                        <Badge
                          variant="outline"
                          className={`text-xs flex-shrink-0 ${warning.type === 'quota_exhausted'
                              ? 'border-red-500/30 text-red-400 bg-red-500/10'
                        ...
                        <div className="flex-1 min-w-0">
                          <span className="text-amber-400/80 break-words">{warning.message}</span>
                          <span className="text-amber-400/40 text-xs ml-2">({warning.keyId})</span>
                        </div>
                      </div>
                    ))}
                  </div>
